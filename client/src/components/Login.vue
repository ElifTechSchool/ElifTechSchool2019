<template>
  <v-row align="center" justify="center">
    <v-col xl="4" lg="6" md="8" sm="10">
          ...
          <v-row align="center" justify="center">
            <v-form @submit.prevent="loginUser" v-model="valid">
              ...
              <v-text-field
                ...
                outlined
              ></v-text-field>
              <v-btn block color="primary" type="submit" height="50px"
                >LOGIN</v-btn
              >
            </v-form>
          </v-row>
          <v-row class="float-right">
            <v-btn text small color="primary" @click="forgotPassDialog = true"
      ...
      <ForgotPass
        type="achiv"
        :show="forgotPassDialog"
        @hideModal="forgotPassDialog = false"
      />
    </v-col>
  </v-row>
</template>
