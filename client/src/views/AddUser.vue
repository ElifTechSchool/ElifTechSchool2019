    ...
    <v-col sm="10" md="5">
      <v-form @submit.prevent="submitUser" enctype="multipart/form-data">
        ...
        <v-text-field
          ...
          required
        />
        <v-file-input label="Secelt you profile picture" name="img_url" v-model="user.image_url" accept=".jpg, .png"></v-file-input>
        <v-textarea
            label="Description"
            name="description"
...
export default {
  ...
  methods: {
    async submitUser() {
      ...
      this.user.experience < 0 ? this.user.experience = 0 : this.user.experience;
