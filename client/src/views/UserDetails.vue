...
<v-row justify="center">
  <v-col md="6">
    ...
    <v-row key="1" v-if="!isEditing">
      <v-col md="4">
        <v-img position="center left" :src="this.userData.image_url" alt="user image" aspect-ratio="1"/>
        <p class="rank">{{ userData.rank }}</p>
        <v-card-text>
          <p>
            <v-icon color="primary" class="ma-2">mdi-swap-vertical-bold</v-icon>
            <b>Experience:</b> 
            {{ userData.experience }}
          </p>
          <p>
          ...
          <p>
            <v-icon color="primary" class="ma-2">mdi-account-badge-outline</v-icon>
            <b>Description:</b> 
